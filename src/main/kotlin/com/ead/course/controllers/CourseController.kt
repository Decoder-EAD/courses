...
class CourseController(
    ...
    ): ResponseEntity<Page<CourseModel>> = ResponseEntity.ok(courseService.getCourses(spec, page))
    ...
    @PostMapping
    fun createCourse(@RequestBody @Validated requestBody: CourseDto): ResponseEntity<Any> {
